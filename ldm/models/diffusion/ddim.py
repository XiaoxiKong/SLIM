...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      append_to_context=None, cond_tau=0.4, style_cond_tau=1.0,callback_ddim_timesteps=None,):
        ...
        time_range, num_inference_steps = get_timesteps(total_steps, 0.3, time_range)
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            ...
            model_uncond, model_t = self.model.apply_model(x_in,mask, t_in, c_in, features_adapter=features_adapter).chunk(2)
